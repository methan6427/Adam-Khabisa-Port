      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        <div className="space-y-6 fade-in">
          ...
          <div className="flex justify-center mb-8">
            <div 
              ref={photoRef}
              className="w-48 h-48 rounded-full bg-gradient-to-br from-cyan-500/20 to-blue-600/20 border-4 border-cyan-400/30 flex items-center justify-center overflow-hidden cyan-glow"
            >
              <img 
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
            <button
              ...
              className="px-8 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 text-slate-50 font-semibold rounded-lg hover:from-cyan-600 hover:to-blue-700 transition-all duration-200 hover-scale cyan-glow"
            >
              View Portfolio
            </button>
            <button
              onClick={() => document.querySelector('#contact')?.scrollIntoView({ behavior: 'smooth' })}
              className="px-8 py-3 border-2 border-cyan-400 text-cyan-400 font-semibold rounded-lg hover:bg-cyan-400 hover:text-slate-900 transition-all duration-200 hover-scale"
            >
              Contact Me
            </button>
          </div>
