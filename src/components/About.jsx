...
const About = () => {
  ...
  return (
    <section id="about" ref={aboutRef} className="py-20 px-6 bg-slate-800/30 relative">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-6">
            <div className="glass-effect p-8 rounded-2xl hover:border-cyan-500/50 transition-all duration-300">
              <h3 className="text-2xl font-bold text-slate-50 mb-4">My Journey</h3>
          ...
          {/* Skills Section */}
          <div className="space-y-6">
            <h3 className="text-2xl font-bold text-slate-50 mb-6">Technical Skills</h3>
            <div className="grid grid-cols-2 gap-4">
              {skills.map((skill, index) => (
                <div 
                  key={skill.name} 
                  className="group glass-effect p-4 rounded-xl hover:border-cyan-500/50 transition-all duration-300"
                  style={{
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-slate-50 font-medium group-hover:text-cyan-100 transition-colors">{skill.name}</span>
                  </div>
                </div>
              ))}
            </div>
